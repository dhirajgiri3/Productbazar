...
const DropdownMenuSubTrigger = React.forwardRef(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      "hover:bg-gray-50 hover:text-indigo-600 focus:bg-gray-50 focus:text-indigo-600",
      "data-[highlighted]:bg-gray-50 data-[highlighted]:text-indigo-600",
      "data-[state=open]:bg-gray-50 data-[state=open]:text-indigo-600",
...
const DropdownMenuSubContent = React.forwardRef(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-32 overflow-hidden rounded-xl border border-gray-100/40 bg-white p-2 text-gray-700 shadow-lg backdrop-blur-sm",
