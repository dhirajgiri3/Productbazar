...
// Enhanced Circle component with improved accessibility, animations
  ...
  (
    ...
    return (
      <motion.div
        ...
        style={{
          background: !isActive ? "rgb(255, 255, 255)" : undefined,
            ...
            >
              ...
              {[...Array(3)].map((_, i) => (
                <motion.div
                  ...
                  className="absolute inset-0 rounded-full"
                  style={{
                    background: `${getColorValue(accentColor, 300)}10`,
                  }}
              ...
              <motion.div
                ...
                style={{
                  background: `${getColorValue(accentColor, 200)}20`,
                }}
                animate={{
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  ...
                  boxShadow: "2px 2px 5px -2px rgba(0, 0, 0, 0.03)",
                }}
...
export function ProductBazarEcosystemConnector() {
  ...
  const ecosystemMembers = [
    {
      ...
      gradientFrom: getColorValue("blue", 400),
      gradientTo: getColorValue("blue", 600),
      tooltip:
    ...
    },
    {
      ...
      gradientFrom: getColorValue("emerald", 400),
      gradientTo: getColorValue("emerald", 600),
      tooltip:
    ...
    },
    {
      ...
      gradientFrom: getColorValue("amber", 400),
      gradientTo: getColorValue("amber", 600),
      tooltip:
    ...
    },
    {
      ...
      gradientFrom: getColorValue("rose", 400),
      gradientTo: getColorValue("rose", 600),
      tooltip:
    ...
    },
    {
      ...
      gradientFrom: getColorValue("purple", 400),
      gradientTo: getColorValue("purple", 600),
      tooltip:
    ...
    },
    {
      ...
      gradientFrom: getColorValue("cyan", 400),
      gradientTo: getColorValue("cyan", 600),
      tooltip:
  ...
  return (
    <section
      className="relative w-full flex flex-col items-center justify-center min-h-[600px] md:min-h-[700px] lg:min-h-[800px] py-16 md:py-20 lg:py-24 bg-white"
      ref={containerRef}
      onMouseMove={handleMouseMove}
    ...
    >
      ...
      <motion.div
        className="absolute inset-0 bg-grid-purple-600/[0.07] grid-fade-mask z-0 opacity-20"
        style={{
          backgroundSize: "24px 24px",
          filter: "url(#soft-shadow-light)",
        }}
        animate={
          !prefersReducedMotion
            ? {
      ...
      {!prefersReducedMotion && containerVisible && (
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
          {Array.from({ length: 20 }).map((_, i) => {
            ...
            const opacity = pseudoRandom1 * 0.3 + 0.1;
        ...
        >
          ...
          <div className="mb-5">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 tracking-tight">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-violet-600 via-purple-600 to-violet-600">
                Product Bazar
              </span>{" "}
  ...
  >
    ...
    <div className="col-start-2 col-span-1 row-start-2 flex items-center justify-center">
      <div
        ref={centerRef}
        className="z-10 flex items-center justify-center rounded-full bg-white relative size-20 md:size-24 lg:size-28 shadow-lg"
        tabIndex={0}
        role="button"
      ...
      >
        ...
        <div className="absolute inset-0 rounded-full p-[2px] overflow-hidden">
          <div
            className="absolute inset-0 rounded-full bg-gradient-to-br from-violet-500 to-purple-700"
          >
        ...
        <motion.span
          className="text-xs md:text-sm font-medium absolute w-full text-center -bottom-8 text-gray-700"
          animate={
            !prefersReducedMotion
              ? {
                  y: isHovering ? -2 : 0,
        ...
        {/* Continuous ripple effect that animates automatically */}
        {!prefersReducedMotion && (
          <motion.div
          ...
          >
            ...
            {[...Array(4)].map((_, i) => (
              <motion.div
                key={i}
                className="absolute inset-0 rounded-full border border-purple-500/20 opacity-0"
                initial={{
                  scale: 1,
                  opacity: 0.6,
                }}
  ...
  beamConfigs.map((config) => {
    ...
    return (
      <AnimatedBeam
        ...
        className={`text-${member.accentColor}-500`}
        duration={config.duration}
        delay={config.delay}
        pathWidth={0.7 * (config.intensity || 1)}
        pathOpacity={0.1 * (config.intensity || 1)}
