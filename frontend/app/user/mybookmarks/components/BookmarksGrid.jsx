      ...
      {bookmarks.map((bookmark) => {
        ...
        return (
          <motion.div
            ...
            className="group bg-white rounded-xl border border-gray-100 overflow-hidden transition-all duration-300 relative"
          >
            {/* Product Image */}
            <Link
              href={`/product/${slug}`}
            ...
            <div className="p-5">
              <div className="flex justify-between items-start mb-2">
                <Link
                  href={`/product/${slug}`}
                  className="block group-hover:text-violet-600 transition-colors"
                >
              ...
              <div className="grid grid-cols-3 gap-2 mb-4">
                <div className="bg-gray-50 rounded-lg p-2 flex flex-col items-center justify-center border border-gray-100">
                  <UpvoteButton
                    product={product}
