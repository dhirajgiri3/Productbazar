      ...
      try {
        ...
        try {
          if (req.query.state) {
            ...
            redirectUrl = state.redirectUrl || '/products';
          }
        } catch (stateError) {
        ...
        let finalRedirectPath = "/products"; // Default redirect to products page
        ...
        if (!user.isProfileCompleted) {
          ...
          finalRedirectPath = "/products"; // Redirect new users to products page too
          logger.info(`Redirecting new Google user ${user._id} to products page`);
        }
